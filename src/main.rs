...
fn main(){
    ...
    let area_conversions: [Conversion; 16] = [
      ...
      Conversion{
          ...
          from: String::from("Square Mile"),
          to: String::from("Square Foot"),
          formula: "input * 2.788e+7",
      },
      Conversion{
          index: String::from("7"),
          from: String::from("Square Mile"),
          to: String::from("Square Yard"),
          formula: "input * 3.098e+6",
      },
      Conversion{
          index: String::from("8"),
          from: String::from("Square Mile"),
          to: String::from("Square Inch"),
          formula: "input * 4.014e+9",
      },
      Conversion{
          index: String::from("9"),
    ...
    fn choose_category(conversions: &[Conversion]){
        ...
        for conversion in conversions.iter(){
            println!("{} : {} to {}", conversion.index,conversion.from,conversion.to)
        }
        ...
        for i in 0..conversions.len(){
            ...
            if input_type == &conv.from && output_type == &conv.to{
                output_value =  eval(&(conv.formula)[..].replace("input",&input_value[..])).unwrap().to_string().parse::<f64>().unwrap();
            }
        }
